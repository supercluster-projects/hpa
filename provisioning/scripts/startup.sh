...
#
#   INFISICAL_ENCRYPTION_KEY   Autogenerated if not set (openssl rand -hex 32)
#   INFISICAL_ADMIN_PASSWORD   Autogenerated if not set
#   INFISICAL_AUTH_SECRET      Autogenerated if not set
#
