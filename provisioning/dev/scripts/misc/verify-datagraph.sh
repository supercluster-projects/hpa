...
if [ -f "../steps/step-16-infisical-workloads/verify-infisical-workloads.sh" ]; then
  log "Phase 1: Running verify-infisical-workloads.sh..."
  if bash "../steps/step-16-infisical-workloads/verify-infisical-workloads.sh" ${SCRIPT_ARGS} 2>&1 | tail -1; then
